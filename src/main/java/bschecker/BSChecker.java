...
public class BSChecker {
	...
	public static void main(String[] args) throws InvalidFormatException, IOException{
		String input = "This was a test. Because that was a test.";
...
//		parse(input);
		...
		Main.initialize();
		Bluesheets.loadSettings(new boolean[]{true, false, false, false, false, false, false, false, false, false, false, false, false, false});
		System.out.print("\ninput: " + input);
